...
export default function CartSideBar(props) {
    ...
    const checkoutHandle = () => {
        ...
        dishService.addCartOrder(cartDishes, loginData.userId, orderAmount).then((data) => {
            console.log(data)
        ...
        <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                ...
                <div className="mt-8">
                    <div className="flow-root">
                        <ul role="list" className="my-6 divide-y divide-gray-200">
                            {
                                cartDishes && cartDishes.length && cartDishes.map((product) => {
                                    return (
            ...
            <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                ...
                <div className={cartDishes && cartDishes.length ? "flex justify-center text-center mt-6 " : " hidden justify-center text-center mt-6"}>
                    <BaseButton onClick={checkoutHandle} type="submit" variant="secondary" className="px-4 py-2">Checkout </BaseButton>
                </div>
