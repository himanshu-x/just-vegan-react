...
function Navbar() {
    ...
    return (
        ...
        <nav className="flex items-center justify-between  bg-gray-800 p-4 max-w-[1640px] mx-auto w-full">
            ...
            <div className="flex flex-col">
                <div onClick={handleClick} className=' lg:hidden '>
                    ...
                    {!nav ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 text-white h-6 cursor-pointer">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 5.25h16.5m-16.5 4.5h16.5m-16.5 4.5h16.5m-16.5 4.5h16.5" />
                    </svg>
                        : <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 text-white relative cursor-pointer  h-6">
        ...
        // block mt-4 text-lg lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4
