...
export default function BaseRadioInput(props) {
                    ...
                    options.map((option, index) => {
                        return (
                            <div key={index} className="form-check form-check-inline flex gap-1">
                                ...
                                />
                                <label className="form-check-label inline-block text-gray-800" htmlFor={`radio` + option.optionName}>{option.optionName}</label>
                            </div>
                        )
                    })
                }
