...
export default function BaseButton({ variant, children, className = "px-4 py-2", ...restProps }) {

    const defaultClasses = " items-center  text-white focus:ring-4 font-medium rounded-lg text-md  focus:outline-none"
    const buttonType = {
