...
export default function HeadingCard() {
    ...
    return (
        <div className="max-w-[1400px] mx-auto p-4 py-6 grid md:grid-cols-3 gap-6">
            ...
            <div className="rounded-xl relative hover:scale-105 hover:duration-500 ">
                {/* Overlay  */}
                <div className="absolute w-full h-full bg-black/50 rounded-xl text-white">
                    <p className="font-bold text-2xl px-2 pt-4">New Dishes</p>
                    <p className=" text-xl px-2"> <em> Click Now</em></p>
                    <button className="border-white bg-orange-500 text-black mx-2 absolute bottom-4  hover:bg-lime-600 rounded-md p-2">Order Now</button>
                </div>
            ...
            <div className="rounded-xl relative hover:scale-105 hover:duration-500 ">
                {/* Overlay  */}
                <div className="absolute w-full h-full bg-black/50 rounded-xl text-white">
                    <p className="font-bold text-2xl px-2 pt-4">New Offers</p>
                    <p className=" text-xl px-2"> <em> Click Now</em></p>
                    <button className="border-white bg-orange-500 text-black mx-2 absolute bottom-4  hover:bg-lime-600 rounded-md p-2">Order Now</button>
                </div>
            ...
            <div className="rounded-xl relative hover:scale-105 hover:duration-500">
                ...
                <div className="absolute w-full h-full bg-black/50 rounded-xl text-white">
                    <p className="font-bold text-2xl px-2 pt-4">Today's Special Dish</p>
                    <p className=" text-xl px-2 font-bold "><em>OFF 80%   Click Now</em></p>
                    <button className="border-white bg-orange-500 text-black mx-2 absolute bottom-4 rounded-md p-2 hover:bg-lime-600 ">Order Now</button>
                </div>
