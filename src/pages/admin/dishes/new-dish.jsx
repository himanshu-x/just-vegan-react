...
export default function NewDish() {
    ...
    const { dishName, price, dishCategory, qualityChecksCertified, qualityChecksPreservative, qualityChecksVaccumSealed, carbs, fat, fiber, protein, energy, description, image } = dishFields
    const newDishFields = [
        dishName,
        price,
        dishCategory,
    ...
    return (<div className="container my-4 p-8 rounded-lg shadow-lg mx-auto md:w-2/4  bg-gray-200" >
        ...
        {/* <form className="m-4 flex flex-col gap-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className=" flex flex-col gap-3">
                ...
                <BaseCheckbox name="isCertified" labelName="Certified" register={register} errors={errors}  ></BaseCheckbox>
                <BaseCheckbox name="preservative" labelName="PreservativeFree" register={register} errors={errors}></BaseCheckbox>
                <BaseCheckbox name="isVaccumSealed" labelName=" Vaccum Sealed" register={register} errors={errors}></BaseCheckbox>
            </div>
